...
def summary_model(model, input_size, batch_size=-1, device="cuda"):
    ...
    # logger.info(f"Model Name:{model.__class__.__name__}, Backbone Name:{model.backbone.__class__.__name__}")
    logger.info("----------------------------------------------------------------")
