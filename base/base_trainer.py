...
class BaseTrainer:
    ...
    def __init__(self, model, loss, metrics, optimizer, resume, config, train_logger=None):
        ...
        self.checkpoint_dir = os.path.join(os.path.abspath(config['trainer']['save_dir']),
                                           config["arch"]["type"], start_time)
        self.models_log_dir = os.path.join(os.path.abspath(config['visualization']['log_dir']),
                                           config["arch"]["type"], start_time)
        ...
        config_save_path = os.path.join(self.models_log_dir, 'config.json')
